import { type Config, scrollbarPlugin, typographyPlugin, unimportantPlugin } from './.deps.ts';
import { neonColors } from '../../src/utils/neonColors.ts';
...
const preset: Config = {
  ...
  plugins: [scrollbarPlugin, typographyPlugin, unimportantPlugin],
} satisfies Config;
